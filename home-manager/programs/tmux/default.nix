{
  ...
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      bind e run "tmux capture-pane -e -S - -p -J > /tmp/tmux-edit && tmux new-window 'nvim \"+terminal cat /tmp/tmux-edit\" \"+normal! G\"'" # Open entire history of pane in neovim with colors, scrolled to bottom
